...
{
    public class GetByIdEventQueryHandlerTest : TestCommandBase
    {
        private readonly IMapper _mapper;

        public GetByIdEventQueryHandlerTest()
        {
        ...
        [Fact]
        public async Task GetByIdEventEventQueryHandlerTest_Should()
        {
            // Arrange
            var repository = new EventRepository(context);
            var handler = new GetByIdEventQueryHandler(_mapper, repository);
            var query = new GetByIdEventQuery(1);
            // Act
