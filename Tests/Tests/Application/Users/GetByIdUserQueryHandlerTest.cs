...
{
    public class GetByIdUserQueryHandlerTest : TestCommandBase
    {
        ...
        [Fact]
        public async Task GetByIdUserQueryHandlerTest_Should()
        {
            // Arrange
            var repository = new UserRepository(context);
            var handler = new GetByIdUserQueryHandler(_mapper, repository);
            var query = new GetByIdUserQuery(1);
            // Act
